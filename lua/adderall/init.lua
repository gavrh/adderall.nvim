local variants = require("adderall.colors")
local cfg = require("adderall.config").config
local c = variants[cfg.variant]
local utils = require("adderall.utils")
local M = {}
